...
public class ReporteProduccionControlador {
	@Autowired
	private ReporteProduccionServicio reporteProduccionServicio;

	@GetMapping("/produccion/download")
	public ResponseEntity<Resource> download(@RequestParam Map<String, Object> params)
			throws JRException, IOException, SQLException {
		ReporteProduccion dto = reporteProduccionServicio.obtenerReporteProduccion(params);
